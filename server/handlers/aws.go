...
var (
	...
	PresignAWSUpload   = AWS.PresignUpload()
	ListAWSBuckets     = AWS.ListBuckets()
	CreateAWSBucket    = AWS.CreateBucket()
	DeleteAWSBucket    = AWS.DeleteBucket()
	ListAWSVersions    = AWS.ListVersions()
	RestoreAWSVersion  = AWS.RestoreVersion()
	DeleteAWSVersion   = AWS.DeleteVersion()
)
