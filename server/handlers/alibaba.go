...
var (
	...
	PresignAlibabaUpload   = Alibaba.PresignUpload()
	ListAlibabaBuckets     = Alibaba.ListBuckets()
	CreateAlibabaBucket    = Alibaba.CreateBucket()
	DeleteAlibabaBucket    = Alibaba.DeleteBucket()
	ListAlibabaVersions    = Alibaba.ListVersions()
	RestoreAlibabaVersion  = Alibaba.RestoreVersion()
	DeleteAlibabaVersion   = Alibaba.DeleteVersion()
)
